...
class Customer {
    ...
    static async create(customerData) {
        ...
        const [result] = await db.execute(query, [
            customerData.email, hashedPassword, customerData.firstname, customerData.lastname,
            customerData.phone_no || null, customerData.shipping_address || null
        ]);
    ...
    static async findById(id) {
        const query = 'SELECT customer_id, firstname, lastname, email, phone_no, shipping_address FROM CUSTOMER WHERE customer_id = ?';
