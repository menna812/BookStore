      ...
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-column">
            <div className="footer-logo">
              <div className="footer-logo-icon">
                    <img src="/assets/images/logo.png" alt="Booktopia Logo" className="footer-logo-img" />
              </div>
              <span className="footer-logo-text">Booktopia</span>
            </div>
            <p className="footer-description">
              Booktopia: your one-stop online bookstore offering a curated selection of books across all genres. Discover your next great read today.
            </p>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/authors" className="footer-link">Authors</a></li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/help" className="footer-link">Customer Help</a></li>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            Copyright © 2024 Booktopia. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
