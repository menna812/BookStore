        ...
        <div className="footer-grid">
          ...
          <div className="footer-column">
            ...
            <p className="footer-description">
              Booktopia: your one-stop online bookstore offering a curated
              selection of books across all genres. Discover your next great
              read today.
            </p>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="/authors" className="footer-link">
                  Authors
                </a>
              </li>
              <li>
